...
function () {
  ...
  _createClass(Difference, [{
    ...
    key: "hideItems",
    value: function hideItems(array) {
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      } catch (e) {} //my version for popup block
      // if (n === 3) {
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function nextSlide() {
      ...
      var array = Array.from(this.slides);
      var slidesArr = array.filter(function (slide) {
        return slide.tagName !== 'BUTTON';
      });

      for (var i = 0; i < slidesArr.length; i++) {
        if (slidesArr[i].tagName !== 'BUTTON') {
          var active = slidesArr[i];
    ...
    key: "stopAutoplay",
    value: function stopAutoplay(id, next, prev) {
      var _this2 = this;

      var arr = [next].concat([prev]);
